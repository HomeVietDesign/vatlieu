...
class Cgroup {
	...
	public static function enqueue_scripts($hook) {
		global $taxonomy;
		if(($hook=='edit-tags.php' || $hook=='term.php') && $taxonomy=='cgroup') {
			wp_enqueue_style( 'manage-cgroup', THEME_URI.'/assets/css/manage-cgroup.css', [], '' );
			//wp_enqueue_script('manage-cgroup', THEME_URI.'/assets/js/manage-cgroup.js', array('jquery'), '');
		}
	}

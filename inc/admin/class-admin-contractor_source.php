...
class Contractor_Source {

	public static function enqueue_scripts($hook) {
		global $taxonomy;
		if(($hook=='edit-tags.php' || $hook=='term.php') && $taxonomy=='contractor_source') {
			wp_enqueue_style( 'manage-contractor_source', THEME_URI.'/assets/css/manage-contractor_source.css', [], '' );
			//wp_enqueue_script('manage-contractor_source', THEME_URI.'/assets/js/manage-contractor_source.js', array('jquery'), '');
		}
	}
